...
extern volatile unsigned int sound_enabledl;
extern volatile unsigned int sound_enabledb;
extern unsigned int song1playing;
extern unsigned int song2playing;
/* Keeps track of the current note we're playing. */
extern volatile unsigned int current_note_lead;
extern volatile unsigned int current_note_bass;
/* Keeps track of the number of ms elapsed. */
extern volatile unsigned int ms_elapsedl;
extern volatile unsigned int ms_elapsedb;
extern unsigned char song1State;
extern unsigned char song2State;
extern unsigned int gamemode;
extern unsigned int wheel;
extern unsigned int gameover;
extern unsigned int scoreboard;
/*
 ...
 */
void playl(unsigned int note, unsigned int duration_ticks);

void playb(unsigned int note, unsigned int duration_ticks);
/*
